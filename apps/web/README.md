...
The development server is configured to run on `app.gitgazer.localhost` for proper cookie handling and OAuth redirects. You need to add this hostname to your system's hosts file.
...
# Open browser to https://app.gitgazer.localhost:5173
...
- Production backend must include `https://app.gitgazer.localhost:5173` in `ALLOWED_FRONTEND_ORIGINS`
