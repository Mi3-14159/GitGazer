...
#   source_arn                    = aws_dynamodb_table.events.arn
...
#     target_table_name          = local.analytics_tablename
#   }
...
#   --table-name ${aws_dynamodb_table.events.name} \
#   --target-table-config '${jsonencode({
#     UnnestSpec : "FULL",
#     TargetTableName : "${local.analytics_tablename}",
# })}'
# EOT
# }
# }
